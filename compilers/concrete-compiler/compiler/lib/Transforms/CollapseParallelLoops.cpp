  ...
  void runOnOperation() override {
    ...
    module.walk([&](mlir::scf::ForOp forOp) {
      ...
      for (unsigned i = 0, e = loops.size(); i < e; ++i) {
        ...
        // 	auto isValueDefinedAbove = [&](mlir::Value val, mlir::Region
        // &limit) -> bool { 	  if
        // (val.getParentRegion()->isProperAncestor(&limit)) 	    return true;
        // if (val.isa<mlir::BlockArgument>()) 	    return false;
        // 	};
        ...
        // llvm::errs() << "\t valdef coalesceableLoopRanges[" << i << "] : " <<
